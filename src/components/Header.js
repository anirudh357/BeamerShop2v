...
import { CreditCardIcon, LightBulbIcon, LockClosedIcon, MoonIcon } from "@heroicons/react/solid";
    ...
    <header className="relative">
      ...
      <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2">
        ...
        <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
          ...
          <div 
            onClick={() => router.push("/Darkmode")}
            className="relative link flex items-center "
          >  
            <LightBulbIcon id="theme-toggle" className="h-10" />
      ...
      <div className="flex items-center space-x-3 p-2 pl-6 bg-amazon_blue-light text-white text-sm">
        ...
        <p className="link lg:inline:flex hover:bg-yellow-500 bg-yellow-400 rounded cursor-pointer relative transition ease-in-out delay-150   hover: duration-300 ..."><a href="https://github.com/anirudh357"> Made by Anirudh Sharma </a></p>
      </div>
      {leftSideMenuView && (
        <div className="z-40">
          {/* <LeftSideMenu /> */}
